 ...
 */
char font[] = "mononoki:pixelsize=16:antialias=true:autohint=true";
int borderpx = 2;
...
const char *colorname[] = {
    ...
    "#c5c8c6",
    [255] = 0,
    "#c5c8c6", // 256: background
    "#1b2836", // 257: highlight
    "#1A1C1D", // 258: background
    "#b5bd68", // 259: active_background
    "#1d1f21", // 260: active foreground
    "#282a2e", // 261: border
};
